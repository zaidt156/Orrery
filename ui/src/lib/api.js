...
export const startAgentRun = (id, input = "") => apiSend(`/api/agents/${id}/runs`, "POST", { input });
export const listAgentRuns = (id) => apiGet(`/api/agents/${id}/runs`);
export const getAgentRun = (runId) => apiGet(`/api/agent-runs/${runId}`);
...
export const getIngestStatus = (cid) => apiGet(`/api/collections/${cid}/ingest-status`);
