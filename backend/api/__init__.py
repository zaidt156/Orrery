...
def create_app(session_token: str) -> FastAPI:
    ...
    from backend.api import (
        routes_admin_team, routes_agents, routes_app_settings, routes_approvals, routes_collections,
        routes_conversations, routes_dashboards, routes_data, routes_files, routes_local_models,
        routes_mcp, routes_life, routes_models, routes_projects, routes_providers, routes_skills,
        routes_system, routes_tools,
    )
    for module in (
        ...
        routes_files, routes_tools, routes_life,
    ):
