...
DEFAULT_MANIFEST: dict = {
    "claude_plan": {
        ...
        "variants": [
            ...
            ["claude_plan/fable-1m", "Claude plan - Fable 5 - 1M context", "claude-fable-5[1m]"],
            ["claude_plan/opus", "Claude plan - Opus 5 - adaptive thinking", "claude-opus-5"],
            ["claude_plan/opus-1m", "Claude plan - Opus 5 - 1M context", "claude-opus-5[1m]"],
            ["claude_plan/sonnet", "Claude plan - Sonnet 5 - adaptive thinking", "claude-sonnet-5"],
            ["claude_plan/sonnet-1m", "Claude plan - Sonnet 5 - 1M context", "claude-sonnet-5[1m]"],
            ["claude_plan/haiku", "Claude plan - Haiku 4.5 - fast", "claude-haiku-4-5"],
        ],
    },
    "chatgpt_plan": {
